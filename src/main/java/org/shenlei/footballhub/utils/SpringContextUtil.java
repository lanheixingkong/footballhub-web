...
/**
 * 让静态变量保存到Spring ApplicationContext 可在任何代码任何地方任何时中取出ApplicaitonContext
 */
public class SpringContextUtil implements ApplicationContextAware,
	...
	public static void clearHolder() {
		if (logger.isDebugEnabled()) {
			logger.debug("清除SpringContextUtil中的ApplicationContext:"
					+ applicationContext);
		}
	...
	public void setApplicationContext(ApplicationContext applicationContext) {
		// logger.debug("注入ApplicationContext到SpringContextUtil:{}",
		// applicationContext);

		if (SpringContextUtil.applicationContext != null) {
			logger.info("SpringContextUtil中的ApplicationContext被覆盖, 原有ApplicationContext:"
